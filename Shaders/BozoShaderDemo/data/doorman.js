  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'packaged_data/doorman.data';
      var REMOTE_PACKAGE_BASE = 'doorman.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_packaged_data/doorman.data');

      };
      Module['addRunDependency']('datafile_packaged_data/doorman.data');
